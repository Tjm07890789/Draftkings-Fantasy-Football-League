        ...
        <Table className="table-fixed w-max min-w-full max-w-none overflow-hidden text-[0.78rem]">
          <TableHeader>
            ...
            <TableRow className="h-7 py-0 text-[0.8rem]">
              <TableHead
                className="z-20 h-7 bg-green-950/95 px-2 py-1 text-left text-[0.78rem]"
                style={{ width: "var(--rank-col-width)", minWidth: "var(--rank-col-width)" }}
              >
                <span className="pl-1">#</span>
              </TableHead>
              <TableHead
                className="z-20 h-7 border-r border-white/25 bg-green-950/95 px-2 py-1 text-[0.78rem]"
              ...
              {Array.from({ length: 18 }, (_, index) => (
                <TableHead
                  ...
                  className={`z-20 h-7 bg-green-950/95 py-1 text-center text-[0.8rem] ${index === 0 ? "pl-[2px]" : "px-[1px]"}`}
              ...
              <TableHead
                className="z-20 h-7 bg-green-950/95 px-[1px] py-1 text-center text-[0.78rem]"
                style={{ width: "var(--data-col-width)", minWidth: "var(--data-col-width)" }}
              >
                <button
                  type="button"
